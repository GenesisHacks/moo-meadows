...
public class FlowerCowEntity extends AnimalEntity implements GeoEntity {

    

    public FlowerCowEntity(EntityType<? extends AnimalEntity> type, World world) {
        super(type, world);
    ...
    public FlowerCowEntity createChild(ServerWorld world, PassiveEntity entity) {
        return null;
    }
