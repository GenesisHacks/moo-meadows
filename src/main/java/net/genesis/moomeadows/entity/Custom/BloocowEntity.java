...
public class BloocowEntity extends AnimalEntity implements GeoEntity {
   


    public BloocowEntity(EntityType<? extends AnimalEntity> type, World world) {
        super(type, world);
    ...
    public BloocowEntity createChild(ServerWorld world, PassiveEntity entity) {
        return null;
    }
