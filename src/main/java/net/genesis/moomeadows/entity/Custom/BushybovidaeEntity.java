...
public class BushybovidaeEntity extends AnimalEntity implements GeoEntity {

    

    public BushybovidaeEntity(EntityType<? extends AnimalEntity> type, World world) {
        super(type, world);
    ...
    public BushybovidaeEntity createChild(ServerWorld world, PassiveEntity entity) {
        return null;
    }
