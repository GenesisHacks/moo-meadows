...
public class OxeneyeEntity extends AnimalEntity implements GeoEntity {

   


    public OxeneyeEntity(EntityType<? extends AnimalEntity> type, World world) {
        super(type, world);
    ...
    public OxeneyeEntity createChild(ServerWorld world, PassiveEntity entity) {
        return null;
    }
